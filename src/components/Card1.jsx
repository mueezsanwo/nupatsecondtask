              ...
              <div className=' h-[586px] w-[fill] '>
                <div className=' h-[346px] w-[fill] rounded-xl p-4 bg-white mt-6 drop-shadow-3xl '>
                  <div className=' flex justify-center'>
                   <img src={CardImage} alt='/' className=' l:w-[234px] ss:w-[234px] 2xl:w-[280px] w-[440px] h-[168px] ' />
                   </div>
                   <div className=' flex'>
                   ...
                   <div className=' l:w-[234px] ss:w-[234px] 2xl:w-[265px] 2xl:ml-1 w-[435px] h-[66px] left-4 mt-[18px] '>
                     ...
                     <div className=' l:w-[234px] ss:w-[234px] 2xl:w-[288px] w-[430px] h-2 rounded-3xl bg-[#EBEBEB] mt-[8.5px]'></div>
