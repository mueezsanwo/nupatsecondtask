...
const Card1 = () => {
  return (
        <div className=' w-[460px] h-[661px] 2xl:w-[320px] l:w-[266px] ss:w-[266px]  '>
              ...
              <div className=' h-[586px] w-[fill] ss:h-[420px] m:h-[420px] '>
                <div className=' h-[346px] w-[fill] rounded-xl p-4 bg-white mt-6 drop-shadow-3xl '>
                  <div className=' flex justify-center'>
                   <img src={CardImage2} alt='/' className=' lg:w-[234px] ss:w-[234px] 2xl:w-[280px] w-[440px] h-[168px] ' />
                   </div>
                   <div className=' flex'>
                   ...
                   <div className=' l:w-[234px] ss:w-[234px] 2xl:w-[265px] 2xl:ml-1 w-[435px] h-[66px] left-4 mt-[18px] '>
                     ...
                     <div className=' l:w-[234px] ss:w-[234px] 2xl:w-[288px] w-[430px] h-2 rounded-3xl bg-[#EBEBEB] mt-[8.5px]'>
                      <div className=' l:w-[114px] ss:w-[114px] 2xl:w-[158px] w-[230px] h-2 rounded-3xl bg-[#FF5F37] mt-[8.5px]'></div>
                     </div>
