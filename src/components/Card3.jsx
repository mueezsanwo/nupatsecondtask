...
const Card3 = () => {
  return (
        <div className=' w-[460px] h-[661px] 2xl:w-[320px] lg:w-[266px]  '>
        ...
        <div className=' h-[575px] w-[fill]'>
        <div className=' w-[fill] h-[155px] bg-white rounded-xl drop-shadow-3xl mt-[14px] 2xl:left-4  '>
                <div className=' flex p-4 '>
                   <div className=' lg:w-[234px] 2xl:w-[275px]  w-[435px] h-[44px] left-4 '>
                    <p className=' lg:w-[191px] 2xl:w-[246px] w-[400px] h-[19px] font-semibold text-[16px] leading-[19px] text-left align-top text-black '>Usability testing</p>
                    <p className=' lg:w-[191px] 2xl:w-[246px] w-[400px] h-[18px] font-normal text-[14px] leading-[17px] text-left align-top text-[#B8B9BD] mt-[8px]'>Make clear design and color</p>
                   </div>
                   <img src={Threedot} alt='/' />
                   </div>
                   <div className=' lg:w-[234px] 2xl:w-[288px] w-[435px] h-[60px] ml-4  '>
                     <div className=' lg:w-[234px] 2xl:w-[288px] w-[435px] h-[18px] flex justify-between items-center'>
                     ...
                     <div className=' lg:w-[234px] 2xl:w-[288px] w-[430px] h-2 rounded-3xl bg-[#EBEBEB] mt-[8.5px]'>
                      <div className=' lg:w-[234px] 2xl:w-[288px] w-[330px] h-2 rounded-3xl bg-[#8BC488] mt-[8.5px]'></div>
                     </div>
                     <div className=' lg-w-[234px] 2xl:w-[270px] w-[fill] h-[24px] mt-2 flex justify-between'>
                        <div className=' flex justify-between items-center'>
                         <div className=' lg:w-[175px] 2xl:w-[236px] flex w-[376px]'>
              ...
              <div className=' h-[346px] w-[fill] rounded-xl p-4 bg-white mt-6 drop-shadow-3xl '>
                  <div className=' flex justify-center'>
                   ...
                   <div className=' flex'>
                   <div className=' lg:w-[234px] 2xl:w-[275px] 2xl:ml-1 w-[435px] h-[44px] left-4 mt-[18px]'>
                    <p className=' lg:w-[191px] 2xl:w-[240px] w-[400px] h-[19px] font-semibold text-[16px] leading-[19px] text-left align-top text-black '>Highfidelity Design</p>
                    <p className=' lg:w-[191px] 2xl:w-[240px] w-[400px] h-[18px] font-normal text-[14px] leading-[17px] text-left align-top text-[#B8B9BD] mt-[8px]'>Make clear design and color</p>
                   </div>
                   <img src={Threedot} alt='/' />
                   </div>
                   <div className=' lg:w-[234px] 2xl:w-[265px] 2xl:ml-1 w-[435px] h-[66px] left-4 mt-[18px] '>
                     <div className=' lg:w-[234px] 2xl:w-[288px] w-[435px] h-[18px] flex justify-between items-center'>
                        <div className=' flex justify-between items-center'>
                            <img src={List} alt='/' className=' w-[18px] h-[18px]' />
                            <p className=' h-[17px] font-normal text-[14px] leading-4 text-left align-top text-[#B8B9BD] ml-1'>Progress</p>
                     ...
                     <div className=' lg:w-[234px] 2xl:w-[288px] w-[435px] h-[24px] mt-2 flex justify-between'>
                        <div className=' flex justify-between items-center'>
                        <div className=' flex justify-center items-center'>
                            <img src={ChatTeardropDots} alt='/' className=' w-[18px] h-[18px]' />
                            <p className='w-[18px] h-[15px] font-normal text-[12px] leading-[14.5px] text-[#B8B9BD] text-left align-top ml-1'>7</p>
